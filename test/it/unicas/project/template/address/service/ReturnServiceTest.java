...
public class ReturnServiceTest {
    ...
    public void setUp() {
        ...
        // Materiales
        Material m1 = new Material(); m1.setIdMaterial(1); m1.setTitle("Java Book"); m1.setMaterial_status("loaned"); m1.setIdMaterialType(1); materials.add(m1);
        Material m2 = new Material(); m2.setIdMaterial(2); m2.setTitle("Python Book"); m2.setMaterial_status("available"); m2.setIdMaterialType(1); materials.add(m2);

        // Préstamos
        Loan l1 = new Loan(); l1.setIdLoan(1); l1.setIdUser(1); l1.setIdMaterial(1);
        l1.setStart_date(LocalDateTime.now().minusDays(10));
        l1.setDue_date(LocalDateTime.now().minusDays(1));
        l1.setReturn_date(null);
        loans.add(l1);

        Loan l2 = new Loan(); l2.setIdLoan(2); l2.setIdUser(2); l2.setIdMaterial(2);
